...
export default function Goal() {
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity onPress={()=>navigation.navigate('MainHome')}><Image style={{height:40,width:40,top:'150%',left:'2%'}} source={require('../assets/newAssets/icons8-back-50.png')}></Image></TouchableOpacity>
