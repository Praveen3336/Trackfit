...
<View style={{flexDirection:'row',justifyContent:'space-between',width:width*0.8,alignSelf:'center',position:'absolute',bottom:20,gap:20}}>
    <TouchableOpacity onPress={()=>navigation.goBack()} style={{height:50,width:width*0.4,backgroundColor:'white',justifyContent:'center',alignItems:'center',borderRadius:5}}><Text style={{color: 'black',
        fontSize: 18,
        fontWeight: '600',}}>Back</Text></TouchableOpacity>
    <TouchableOpacity onPress={()=>navigation.navigate("Step4")} style={{height:50,width:width*0.4,backgroundColor:'white',justifyContent:'center',alignItems:'center',borderRadius:5}}><Text style={{color: 'black',
        fontSize: 18,
        fontWeight: '600',}}>Next</Text></TouchableOpacity>
</View>
        </View>
    );
};
